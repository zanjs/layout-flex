...
PC
  如果你不需要兼容ie10以下版本，也是可以使用layout-flex
  
layout-flex同时能兼容新版本和旧版本，保证了浏览器不支持新版本时，回退到旧版本。
```  
...
<!--
  ...
  layout-flex.min.css 使用flex属性匹配
  data-layout-flex.min.css 使用data-flex属性匹配（React使用）
